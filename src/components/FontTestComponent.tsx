...
const FontTestComponent = () => {
  ...
  const getPlatformFont = (baseFontName) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.text, { fontFamily: getPlatformFont(fonts.thin) }]}>
        Thin: {getPlatformFont(fonts.thin)} (Platform-specific)
      </Text>
      <Text style={[styles.text, { fontFamily: getPlatformFont(fonts.light) }]}>
        Light: {getPlatformFont(fonts.light)} (Platform-specific)
      </Text>
      <Text style={[styles.text, { fontFamily: getPlatformFont(fonts.regular) }]}>
        Regular: {getPlatformFont(fonts.regular)} (Platform-specific)
      </Text>
      <Text style={[styles.text, { fontFamily: getPlatformFont(fonts.bold) }]}>
        Bold: {getPlatformFont(fonts.bold)} (Platform-specific)
      </Text>
      <Text style={[styles.text, { fontFamily: getPlatformFont(fonts.black) }]}>
        Black: {getPlatformFont(fonts.black)} (Platform-specific)
      </Text>
